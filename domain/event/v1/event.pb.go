...
import (
	_ "github.com/mito/core/domain/account/v1"
...
const (
	...
	Topic_TOPIC_ACCOUNT_UPDATED Topic = 1
)
...
var (
	Topic_name = map[int32]string{
		0: "TOPIC_UNSPECIFIED",
		1: "TOPIC_ACCOUNT_UPDATED",
	}
	Topic_value = map[string]int32{
		"TOPIC_UNSPECIFIED":     0,
		"TOPIC_ACCOUNT_UPDATED": 1,
	}
)
...
func (x *AccountUpdatePayload) Reset() {
	*x = AccountUpdatePayload{}
...
func (x *AccountUpdatePayload) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AccountUpdatePayload) ProtoMessage() {}

func (x *AccountUpdatePayload) ProtoReflect() protoreflect.Message {
	mi := &file_event_v1_event_proto_msgTypes[0]
...
// Deprecated: Use AccountUpdatePayload.ProtoReflect.Descriptor instead.
func (*AccountUpdatePayload) Descriptor() ([]byte, []int) {
	return file_event_v1_event_proto_rawDescGZIP(), []int{0}
}

func (x *AccountUpdatePayload) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
var file_event_v1_event_proto_rawDesc = []byte{
	...
	,
...
var file_event_v1_event_proto_goTypes = []interface{}{
	...
	(*AccountUpdatePayload)(nil), // 1: event.v1.AccountUpdatePayload
}
...
func file_event_v1_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_event_v1_event_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AccountUpdatePayload); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
